...
# Data parameters
data_name = 'ai2thor_changes_embscu'
...
def train(train_loader, res101, encoder, decoder, criterion, encoder_optimizer, decoder_optimizer, epoch, word_map):
  ...
  # Batches
  for i, (imgs0_0, imgs0_1, caps, caplens, abs_embeddings_before,abs_embeddings_after,obj_fea_bef,obj_fea_aft,class_bef,class_aft) in enumerate(train_loader):
    data_time.update(time.time() - start)
    #print (abs_embeddings_before.shape)
    ...
    l = encoder(imgs0_0, imgs0_1, imgsbef,imgsaft, obj_fea_bef,obj_fea_aft,class_bef,class_aft) ### change shape ----
