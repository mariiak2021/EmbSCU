...
def evaluate(args, beam_size):
  ...
  # For each image
  with torch.no_grad():
    for i, (imgs0_0, imgs0_1, caps, caplens, abs_embeddings_before,abs_embeddings_after,obj_fea_bef,obj_fea_aft,class_bef,class_aft) in enumerate(
      ...
      with autocast():
        ...
        imgsbef = abs_embeddings_before.to(device)
        imgsaft = abs_embeddings_after.to(device)
        ...
        memory = encoder(imgs0_0, imgs0_1, imgsbef,imgsaft, obj_fea_bef,obj_fea_aft,class_bef,class_aft)
...
if __name__=='__main__':
  ...
  parser.add_argument('--checkpoint', default='/home/mkhan/embclip-rearrangement/change_recognition/pano_code/EmbSCU2/results/checkpoint_epoch_39_ai2thor_changes_embscu.pth.tar')
