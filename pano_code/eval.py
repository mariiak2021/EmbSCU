...
if __name__=='__main__':
  ...
  parser.add_argument('--checkpoint', default='/home/mkhan/embclip-rearrangement/change_recognition/pano_code/results/checkpoint_epoch_39_ai2thor_changes_imgfeaonly.pth.tar')
  ...
  parser.add_argument('--model_name', default='39fea')
