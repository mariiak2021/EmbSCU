...
class CaptionDataset(Dataset):
  ...
  def __getitem__(self, i):
    ...
    def extract_number_from_filename(file_path):
      # Split by '-' and take the last part before '.png'
      
      filename = file_path.split('/')[-1]  # Get the filename part
      #print (filename)
      number = filename.split('-')[-1].split('.')[0]  # Extract the number before '.png'
    ...
    return captions, caplens,abs_embeddings_before,abs_embeddings_after,obj_fea_bef,obj_fea_aft,class_bef,class_aft#img0_0, img0_1, captions, caplens,img_fea_bef, img_fea_aft,obj_fea_bef,obj_fea_aft,class_bef,class_aft
