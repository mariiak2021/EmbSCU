...
def evaluate(args, beam_size):
  ...
  # For each image
  for i, (imgs0_0, imgs0_1, caps, caplens) in enumerate(
    ...
    memory = encoder(imgs0_0, imgs0_1)
...
if __name__=='__main__':
  ...
  parser.add_argument('--checkpoint', default='/home/mkhan/embclip-rearrangement/change_recognition/pano_code/MCC/results/checkpoint_epoch_39_ai2thor_changes.pth.tar')
  ...
  parser.add_argument('--model_name', default='39ori')
